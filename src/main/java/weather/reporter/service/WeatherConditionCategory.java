...
public enum WeatherConditionCategory {
    ...
    GENERAL_ERROR("https://media.giphy.com/media/l41JNsXAvFvoHvWJW/giphy.gif"),
    INTERNET_CONNECTION_ERROR("https://media.giphy.com/media/l41JNsXAvFvoHvWJW/giphy.gif");
